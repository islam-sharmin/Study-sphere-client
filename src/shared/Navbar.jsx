...
const Navbar = () => {
    ...
    return (
        <div className="navbar bg-base-100 border-b border-yellow-400">
            <div className="navbar-start">
                ...
                <a className="btn btn-ghost text-xl lg:text-2xl font-bold"><span className="text-yellow-600">Study</span>Sphere</a>
            </div>
